...
class DoctorGetTest {
    ...
    inner class GetByDoctorID {
        ...
        fun `should return 200 when doctor is found`() {
            val result =
                mockMvc.perform(
                    MockMvcRequestBuilders.get("/doctors/${doctorDto.doctorID}").headers(
                        HttpHeaders().apply {
        ...
        fun `should return 404 when doctor is not found`() {
            ...
            val result =
                mockMvc.perform(
                    MockMvcRequestBuilders.get("/doctors/${doctorID.value}").headers(
                        HttpHeaders().apply {
    ...
    inner class GetByHospitalID {
        ...
        fun `should return empty list when doctors are not found`() {
            ...
            val result =
                mockMvc.perform(
                    MockMvcRequestBuilders.get("/hospitals/$hospitalID/doctors").headers(
                        HttpHeaders().apply {
                            add("X-UID", "doctor")
                        },
                    )
    ...
    inner class GetDoctors {
        ...
        fun `should return 200 when all doctors are found`() {
            val result =
                mockMvc.perform(
                    MockMvcRequestBuilders.get("/doctors").headers(
                        HttpHeaders().apply {
                            add("X-UID", "doctor")
                        },
                    )
