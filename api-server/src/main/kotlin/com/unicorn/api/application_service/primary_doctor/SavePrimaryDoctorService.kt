...
import com.unicorn.api.controller.primary_doctor.PrimaryDoctorPostRequest
...
interface SavePrimaryDoctorService {
    fun save(uid: String, primaryDoctorPostRequest: PrimaryDoctorPostRequest): PrimaryDoctors
}
...
class SavePrimaryDoctorServiceImpl(
    ...
    @Transactional
    override fun save(uid: String, primaryDoctorPostRequest: PrimaryDoctorPostRequest): PrimaryDoctors {
